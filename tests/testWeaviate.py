...
from storage.weaviatestorage import DockerUtil, Weaviate
...
class TestWeaviate(unittest.TestCase):
    ...
    def testEventSchema(self):
        ...
        schema = {
            ...
            "classes": [
                ...
                },
                {
                    ...
                    "description": "city",
                    "properties": [
                        {"name": "name", "description": "name", "dataType": ["text"]},
                        {
                            "name": "hasEvent",
        ...
        client.data_object.create(
            event, "Event", "2a8d56b7-2dd5-4e68-aa40-53c9196aecde"
        )
        city = {"name": "Amsterdam"}
        ...
        client.data_object.reference.add(
            "c60505f9-8271-4eec-b998-81d016648d85",
            "hasEvent",
            "2a8d56b7-2dd5-4e68-aa40-53c9196aecde",
        )
